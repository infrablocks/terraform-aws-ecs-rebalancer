  ...
  namespace :secrets do
    namespace :gpg do
      RakeGPG.define_generate_key_task(
        ...
        owner_comment: 'terraform-aws-ecs-rebalancer CI Key'
      )
    end
...
RakeCircleCI.define_project_tasks(
  namespace: :circle_ci,
  project_slug: 'github/infrablocks/terraform-aws-ecs-rebalancer'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
  namespace: :github,
  repository: 'infrablocks/terraform-aws-ecs-rebalancer'
) do |t|
  github_config =
